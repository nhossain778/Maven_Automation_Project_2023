...
public class T1_MouseActions {
    public static void main(String[] args) throws InterruptedException {
        ...
        //try{
            //WebElement trackclick = driver.findElement(By.xpath("//*[@class='button tracking-btn']'"));
            //mouseAction.moveToElement(trackclick).click().sendKeys("12345678").perform();
        //} catch (Exception e) {
            //System.out.println("Unable to click on Tracking Input: " + e);
